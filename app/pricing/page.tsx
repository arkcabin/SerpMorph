...
const pricingPlans = [
  {
    name: "Starter",
    price: "$0",
    subtitle: "Perfect for testing SerpMorph",
  ...
  },
  {
    ...
    features: ["10 domains", "Daily sync", "Advanced page insights", "Email alerts"],
  },
  {
    name: "Agency",
    price: "$99/mo",
    subtitle: "For agencies and large SEO operations",
    features: ["Unlimited domains", "Multi-user team access", "Priority support", "Custom reporting"],
  },
]
    ...
    <main className="mx-auto min-h-svh w-full max-w-6xl px-6 py-16">
      <div className="max-w-2xl space-y-3">
        ...
        <p className="text-muted-foreground">
          Choose the plan that matches your SEO workflow. Start free and upgrade as your data needs grow.
        </p>
      </div>
